...
CREATE UNIQUE INDEX product_default_variant_unique ON product_variants(product_id) WHERE is_default;
...
CREATE INDEX notifications_user_unread_idx ON notifications(admin_user_id, read_at, created_at DESC);
